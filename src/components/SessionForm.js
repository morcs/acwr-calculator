      ...
      <div className="panel panel-default" key={index}>
        ...
        <div className="panel-body form-horizontal">
          <div className="form-group">
            <label htmlFor="intensity" className="col-sm-3 control-label">Intensity/sRPE (1-10)</label>
          ...
          {' '}
          <div className="form-group">
            <label htmlFor="duration" className="col-sm-3 control-label">Duration (mins)</label>
            <div className="col-sm-9">
